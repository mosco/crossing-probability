...
def test_ecdf2ks2001():
    assert run('./bin/crossprob ecdf2-ks2001 tests/bounds2.txt').strip() == b'0.25'
    assert run('./bin/crossprob ecdf2-ks2001 tests/bounds8.txt').strip() == b'0.159471'
    assert run('./bin/crossprob ecdf2-ks2001 tests/bounds_cksplus_10.txt').strip() ==  b'0.391076'
    assert run('./bin/crossprob ecdf2-ks2001 tests/bounds_cksminus_10.txt').strip() ==  b'0.391076'
...
def test_ecdf1mns2016():
    assert run('./bin/crossprob ecdf1-mns2016 tests/bounds_cksminus_10.txt').strip() ==  b'0.391076'
    assert run('./bin/crossprob ecdf1-mns2016 tests/bounds_cksplus_10.txt').strip() ==  b'0.391076'

def test_ecdf2mn2017():
    assert run('./bin/crossprob ecdf2-mn2017 tests/bounds_cksminus_10.txt').strip() ==  b'0.391076'
    assert run('./bin/crossprob ecdf2-mn2017 tests/bounds_cksplus_10.txt').strip() ==  b'0.391076'

def test_ecdf1m2020():
    assert run('./bin/crossprob ecdf1-new tests/bounds_cksminus_10.txt').strip() ==  b'0.391076'
    assert run('./bin/crossprob ecdf1-new tests/bounds_cksplus_10.txt').strip() ==  b'0.391076'
