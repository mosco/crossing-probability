...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_crossprob', [dirname(__file__)])
        except ImportError:
            import _crossprob
            return _crossprob
        if fp is not None:
            try:
                _mod = imp.load_module('_crossprob', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _crossprob = swig_import_helper()
...
class SwigPyIterator(_object):
    ...
    def __iter__(self):
        return self
SwigPyIterator_swigregister = _crossprob.SwigPyIterator_swigregister
...
class VectorDouble(_object):
    ...
    def __init__(self, *args):
        this = _crossprob.new_VectorDouble(*args)
        try:
    ...
    __del__ = lambda self: None
VectorDouble_swigregister = _crossprob.VectorDouble_swigregister
